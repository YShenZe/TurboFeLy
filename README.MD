...
```html
<!-- 生产环境 -->
<script src="https://cdn.jsdelivr.net/npm/turbofely@latest/dist/turbofely.min.js"></script>

<!-- ESM模块 -->
<script type="module">
  import TurboFeLy from 'https://cdn.jsdelivr.net/npm/turbofely@latest/dist/turbofely.esm.js'
</script>
```
